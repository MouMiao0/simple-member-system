 ...
 * @LastEditTime: 2022-12-06 04:56:40
 * @FilePath: \electron-vite-vue\electron\services\IUserServices.d.ts
 * @Description: 
 * 
...
interface IUserServices
{
     ...
     * @returns 修改结果
     */
    modifiedUserPw: (before_password: string, after_password: string)=>Promise<number>
